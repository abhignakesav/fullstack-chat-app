        ...
        <div className="w-full max-w-md space-y-8 p-8 bg-base-200 rounded-xl shadow-lg">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              transition-colors shadow-md group-hover:shadow-lg"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type="submit" className="btn btn-primary w-full transition-all duration-300 ease-in-out transform hover:scale-[1.01]" disabled={isLoggingIn}>
              {isLoggingIn ? (
                <>
