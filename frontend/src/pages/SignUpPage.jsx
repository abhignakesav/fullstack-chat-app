  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8 p-8 bg-base-200 rounded-xl shadow-lg">
          {/* LOGO */}
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              <div
                className="size-12 rounded-xl bg-primary/10 flex items-center justify-center 
              group-hover:bg-primary/20 transition-colors shadow-md group-hover:shadow-lg"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className={`input input-bordered w-full pl-10 bg-base-100 text-base-content placeholder:text-base-content/40 border-base-300 focus:border-primary focus:outline-none`}
            ...
            <button type="submit" className="btn btn-primary w-full transition-all duration-300 ease-in-out transform hover:scale-[1.01]" disabled={isSigningUp}>
              {isSigningUp ? (
                <>
